  ...
  <tr>
	...
	<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
        ...
        <tr>
          ...
          <td width="20" align="center"><a href="index.php?view=cats&amp;do=add"><img src="/images/admin/mainpage/folder_add.png" alt="<?php echo $_LANG['AD_CREATE_SECTION']; ?>" width="16" height="16" border="0" /></a></td>
          <td width="20" align="center"><a href="index.php?view=content&amp;do=add"><img src="/images/admin/mainpage/page_add.png" alt="<?php echo $_LANG['AD_CREATE_ARTICLE']; ?>" width="16" height="16" border="0" /></a></td>
        </tr>
        <?php } ?>
        ...
        <tr>
            ...
            <td align="center"><a href="index.php?view=components&amp;do=config&amp;link=photos&amp;opt=add_album"><img src="/images/admin/mainpage/folder_add.png" alt="<?php echo $_LANG['AD_CREATE_ALBUM']; ?>" width="16" height="16" border="0" /></a></td>
            <td align="center"></td>
        </tr>
        <?php } ?>
        ...
        <tr>
            ...
            <td align="center"><a href="index.php?view=components&amp;do=config&amp;link=video&amp;opt=add_cat"><img src="/images/admin/mainpage/folder_add.png" alt="<?php echo $_LANG['AD_CREATE_CATEGORY']; ?>" width="16" height="16" border="0" /></a></td>
            <td align="center"></td>
        </tr>
        <?php } ?>
        ...
        <tr>
            ...
            <td align="center"><a href="index.php?view=components&amp;do=config&amp;link=maps&amp;opt=add_cat"><img src="/images/admin/mainpage/folder_add.png" alt="<?php echo $_LANG['AD_CREATE_CATEGORY']; ?>" width="16" height="16" border="0" /></a></td>
            <td align="center"><a href="index.php?view=components&amp;do=config&amp;link=maps&amp;opt=add_item"><img src="/images/admin/mainpage/page_add.png" alt="<?php echo $_LANG['AD_ADD_OBJECT']; ?>" width="16" height="16" border="0" /></a></td>
        </tr>
        <?php } ?>
        ...
        <tr>
          ...
          <td align="center"><a href="index.php?view=components&amp;do=config&amp;link=faq&amp;opt=add_cat"><img src="/images/admin/mainpage/folder_add.png" alt="<?php echo $_LANG['AD_CREATE_CATEGORY']; ?>" width="16" height="16" border="0" /></a></td>
          <td align="center"><a href="index.php?view=components&amp;do=config&amp;link=faq&amp;opt=add_item"><img src="/images/admin/mainpage/page_add.png" alt="<?php echo $_LANG['AD_CREATE_QUESTION']; ?>" width="16" height="16" border="0" /></a></td>
        </tr>
        <?php } ?>
        ...
        <tr>
          ...
          <td align="center"><a href="index.php?view=components&amp;do=config&amp;link=board&amp;opt=add_cat"><img src="/images/admin/mainpage/folder_add.png" alt="<?php echo $_LANG['AD_CREATE_RUBRIC']; ?>" width="16" height="16" border="0" /></a></td>
          <td align="center"><a href="index.php?view=components&amp;do=config&amp;link=board&amp;opt=add_item"><img src="/images/admin/mainpage/page_add.png" alt="<?php echo $_LANG['AD_CREATE_ADVERT']; ?>" width="16" height="16" border="0" /></a></td>
        </tr>
        <?php } ?>
        ...
        <tr>
          ...
          <td align="center"><a href="index.php?view=components&amp;do=config&amp;link=catalog&amp;opt=add_cat"><img src="/images/admin/mainpage/folder_add.png" alt="<?php echo $_LANG['AD_CREATE_RUBRIC'];?>" width="16" height="16" border="0" /></a></td>
          <td align="center"><a href="index.php?view=components&amp;do=config&amp;link=catalog&amp;opt=add_item"><img src="/images/admin/mainpage/page_add.png" alt="<?php echo $_LANG['AD_CREATE_ITEM'];?>" width="16" height="16" border="0" /></a></td>
        </tr>
        <?php } ?>
        ...
        <tr>
          ...
          <td align="center"><a href="index.php?view=components&amp;do=config&amp;link=forum&amp;opt=add_cat"><img src="/images/admin/mainpage/folder_add.png" alt="<?php echo $_LANG['AD_CREATE_CATEGORY']; ?>" width="16" height="16" border="0" /></a></td>
          <td align="center"><a href="index.php?view=components&amp;do=config&amp;link=forum&amp;opt=add_forum"><img src="/images/admin/mainpage/page_add.png" alt="<?php echo $_LANG['AD_CREATE_FORUM']; ?>" width="16" height="16" border="0" /></a></td>
        </tr>
        <?php } ?>
    </table>
	</div>
	...
	<div class="small_box">
		...
		<div style="padding:8px">
		  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
            <tr>
              <td width="16"><img src="/images/admin/icons/hmenu/users.png" width="16" height="16" /></td>
              <td><a href="index.php?view=users"><?php echo $_LANG['AD_FROM_USERS']; ?></a> &mdash; <?php echo $inDB->rows_count('cms_users', 'is_deleted=0'); ?></td>
            </tr>
            <tr>
              <td><img src="/images/admin/icons/hmenu/users.png" width="16" height="16" /></td>
            ...
            <div class="small_box">
                ...
                <div style="padding:10px">
                    <table width="100%" border="0" cellspacing="0" cellpadding="2" align="center">
                      <?php if ($new_content){ ?>
                      <tr>
                        <td width="16"><img src="/images/admin/updates/content.gif" width="16" height="16" /></td>
                      ...
                      <?php if ($new_quests){ ?>
                      <tr>
                        <td width="16"><img src="/images/admin/updates/quests.gif" width="16" height="16" /></td>
        ...
        <div class="small_box">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="2" align="center">
              ...
              <tr>
                <td></td>
                <td></td>
                <td><img src="/images/admin/icons/config.png" width="16" height="16" /></td>
